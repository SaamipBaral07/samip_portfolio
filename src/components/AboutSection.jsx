                    ...
                    <div className="lg:col-span-7 relative group">
                        ...
                        >
                            ...
                            <div className="relative z-10 flex flex-col sm:flex-row gap-3 mt-4 pt-4 border-t border-gray-200 dark:border-white/10 transition-colors">
                                ...
                                <a href="/projects/Samip_Baral-CV.pdf" className="px-5 py-2 rounded-xl border border-gray-300 dark:border-white/10 bg-white dark:bg-white/5 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-white/10 hover:text-gray-900 dark:hover:text-white transition-all text-xs md:text-sm flex items-center justify-center font-medium backdrop-blur-sm min-w-[120px]" target="_blank" rel="noopener noreferrer">
                                    Download CV
                                </a>
                            </div>
                        </motion.div>
